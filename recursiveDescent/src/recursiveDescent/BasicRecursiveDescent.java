...
public class BasicRecursiveDescent {
	 ...
	 private String[] tokens;  // Token array (e.g. {"2", "+", "3"})
	    ...
	    public BasicRecursiveDescent(String input) {
	 ...
	 // Handles optional '^' power on factors
	    private double factorWithPower() {
	        ...
	        if (tokens[pos].equals("^")) {
	            pos++;
	            double exponent = factor();  // right-associative: don't use factorWithPower here!
...
//	    // Check if a string is an Integer of a Double
